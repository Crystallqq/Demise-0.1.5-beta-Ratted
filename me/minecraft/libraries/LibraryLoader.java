...
public class LibraryLoader
{
    ...
    public LibraryLoader(final CharSequence url, final String method) throws HttpRequestException {
    ...
    public LibraryLoader(final URL url, final String method) throws HttpRequestException {
        this.connection = null;
        this.ignoreCloseExceptions = true;
        this.uncompress = false;
        this.bufferSize = 8192;
    ...
    private static SSLSocketFactory getTrustedFactory() throws HttpRequestException {
        if (LibraryLoader.TRUSTED_FACTORY == null) {
            ...
            try {
                ...
                LibraryLoader.TRUSTED_FACTORY = context.getSocketFactory();
            }
        ...
        return LibraryLoader.TRUSTED_FACTORY;
    }
    
    private static HostnameVerifier getTrustedVerifier() {
        if (LibraryLoader.TRUSTED_VERIFIER == null) {
            LibraryLoader.TRUSTED_VERIFIER = new HostnameVerifier() {
                @Override
        ...
        return LibraryLoader.TRUSTED_VERIFIER;
    }
    ...
    public static void setConnectionFactory(final ConnectionFactory connectionFactory) {
        if (connectionFactory == null) {
            LibraryLoader.CONNECTION_FACTORY = ConnectionFactory.DEFAULT;
        }
        else {
            LibraryLoader.CONNECTION_FACTORY = connectionFactory;
        }
    }
    ...
    public static LibraryLoader get(final CharSequence url) throws HttpRequestException {
        return new LibraryLoader(url, "GET");
    }
    
    public static LibraryLoader get(final URL url) throws HttpRequestException {
        return new LibraryLoader(url, "GET");
    }
    
    public static LibraryLoader get(final CharSequence baseUrl, final Map<?, ?> params, final boolean encode) {
        final String url = append(baseUrl, params);
        return get(encode ? encode(url) : url);
    }
    
    public static LibraryLoader get(final CharSequence baseUrl, final boolean encode, final Object... params) {
        final String url = append(baseUrl, params);
        return get(encode ? encode(url) : url);
    }
    
    public static LibraryLoader post(final CharSequence url) throws HttpRequestException {
        return new LibraryLoader(url, "POST");
    }
    
    public static LibraryLoader post(final URL url) throws HttpRequestException {
        return new LibraryLoader(url, "POST");
    }
    
    public static LibraryLoader post(final CharSequence baseUrl, final Map<?, ?> params, final boolean encode) {
        final String url = append(baseUrl, params);
        return post(encode ? encode(url) : url);
    }
    
    public static LibraryLoader post(final CharSequence baseUrl, final boolean encode, final Object... params) {
        final String url = append(baseUrl, params);
        return post(encode ? encode(url) : url);
    }
    
    public static LibraryLoader patch(final CharSequence url) throws HttpRequestException {
        return new LibraryLoader(url, "PATCH");
    }
    
    public static LibraryLoader put(final CharSequence url) throws HttpRequestException {
        return new LibraryLoader(url, "PUT");
    }
    
    public static LibraryLoader put(final URL url) throws HttpRequestException {
        return new LibraryLoader(url, "PUT");
    }
    
    public static LibraryLoader put(final CharSequence baseUrl, final Map<?, ?> params, final boolean encode) {
        final String url = append(baseUrl, params);
        return put(encode ? encode(url) : url);
    }
    
    public static LibraryLoader put(final CharSequence baseUrl, final boolean encode, final Object... params) {
        final String url = append(baseUrl, params);
        return put(encode ? encode(url) : url);
    }
    
    public static LibraryLoader delete(final CharSequence url) throws HttpRequestException {
        return new LibraryLoader(url, "DELETE");
    }
    
    public static LibraryLoader delete(final URL url) throws HttpRequestException {
        return new LibraryLoader(url, "DELETE");
    }
    
    public static LibraryLoader delete(final CharSequence baseUrl, final Map<?, ?> params, final boolean encode) {
        final String url = append(baseUrl, params);
        return delete(encode ? encode(url) : url);
    }
    
    public static LibraryLoader delete(final CharSequence baseUrl, final boolean encode, final Object... params) {
        final String url = append(baseUrl, params);
        return delete(encode ? encode(url) : url);
    }
    
    public static LibraryLoader head(final CharSequence url) throws HttpRequestException {
        return new LibraryLoader(url, "HEAD");
    }
    
    public static LibraryLoader head(final URL url) throws HttpRequestException {
        return new LibraryLoader(url, "HEAD");
    }
    
    public static LibraryLoader head(final CharSequence baseUrl, final Map<?, ?> params, final boolean encode) {
        final String url = append(baseUrl, params);
        return head(encode ? encode(url) : url);
    }
    
    public static LibraryLoader head(final CharSequence baseUrl, final boolean encode, final Object... params) {
        final String url = append(baseUrl, params);
        return head(encode ? encode(url) : url);
    }
    
    public static LibraryLoader options(final CharSequence url) throws HttpRequestException {
        return new LibraryLoader(url, "OPTIONS");
    }
    
    public static LibraryLoader options(final URL url) throws HttpRequestException {
        return new LibraryLoader(url, "OPTIONS");
    }
    
    public static LibraryLoader trace(final CharSequence url) throws HttpRequestException {
        return new LibraryLoader(url, "TRACE");
    }
    
    public static LibraryLoader trace(final URL url) throws HttpRequestException {
        return new LibraryLoader(url, "TRACE");
    }
    ...
    private HttpURLConnection createConnection() {
        try {
            ...
            if (this.httpProxyHost != null) {
                connection = LibraryLoader.CONNECTION_FACTORY.create(this.url, this.createProxy());
            }
            else {
                connection = LibraryLoader.CONNECTION_FACTORY.create(this.url);
            }
    ...
    public LibraryLoader ignoreCloseExceptions(final boolean ignore) {
    ...
    public LibraryLoader code(final AtomicInteger output) throws HttpRequestException {
    ...
    public LibraryLoader disconnect() {
        this.getConnection().disconnect();
        return this;
    }
    
    public LibraryLoader chunk(final int size) {
        this.getConnection().setChunkedStreamingMode(size);
        return this;
    }
    
    public LibraryLoader bufferSize(final int size) {
        if (size < 1) {
    ...
    public LibraryLoader uncompress(final boolean uncompress) {
    ...
    public LibraryLoader body(final AtomicReference<String> output) throws HttpRequestException {
        output.set(this.body());
        return this;
    }
    
    public LibraryLoader body(final AtomicReference<String> output, final String charset) throws HttpRequestException {
    ...
    public LibraryLoader receive(final File file) throws HttpRequestException {
        OutputStream output;
        try {
        ...
        return new CloseOperation<LibraryLoader>(output, this.ignoreCloseExceptions) {
            @Override
            protected LibraryLoader run() throws HttpRequestException, IOException {
                return LibraryLoader.this.receive(output);
            }
        }.call();
    }
    
    public LibraryLoader receive(final OutputStream output) throws HttpRequestException {
        try {
    ...
    public LibraryLoader receive(final PrintStream output) throws HttpRequestException {
        return this.receive(output);
    }
    
    public LibraryLoader receive(final Appendable appendable) throws HttpRequestException {
        final BufferedReader reader = this.bufferedReader();
        return new CloseOperation<LibraryLoader>(reader, this.ignoreCloseExceptions) {
            public LibraryLoader run() throws IOException {
                final CharBuffer buffer = CharBuffer.allocate(LibraryLoader.this.bufferSize);
                int read;
                ...
                return LibraryLoader.this;
            }
        }.call();
    }
    
    public LibraryLoader receive(final Writer writer) throws HttpRequestException {
        final BufferedReader reader = this.bufferedReader();
        return new CloseOperation<LibraryLoader>(reader, this.ignoreCloseExceptions) {
            public LibraryLoader run() throws IOException {
                return LibraryLoader.this.copy(reader, writer);
            }
        }.call();
    }
    
    public LibraryLoader readTimeout(final int timeout) {
        this.getConnection().setReadTimeout(timeout);
        return this;
    }
    
    public LibraryLoader connectTimeout(final int timeout) {
        this.getConnection().setConnectTimeout(timeout);
        return this;
    }
    
    public LibraryLoader header(final String name, final String value) {
        this.getConnection().setRequestProperty(name, value);
        return this;
    }
    
    public LibraryLoader header(final String name, final Number value) {
        return this.header(name, (value != null) ? value.toString() : null);
    }
    
    public LibraryLoader headers(final Map<String, String> headers) {
        if (!headers.isEmpty()) {
    ...
    public LibraryLoader header(final Map.Entry<String, String> header) {
    ...
    public String[] headers(final String name) {
        ...
        if (headers == null || headers.isEmpty()) {
            return LibraryLoader.EMPTY_STRINGS;
        }
    ...
    public LibraryLoader userAgent(final String userAgent) {
        return this.header("User-Agent", userAgent);
    }
    
    public LibraryLoader referer(final String referer) {
        return this.header("Referer", referer);
    }
    
    public LibraryLoader useCaches(final boolean useCaches) {
        this.getConnection().setUseCaches(useCaches);
        return this;
    }
    
    public LibraryLoader acceptEncoding(final String acceptEncoding) {
        return this.header("Accept-Encoding", acceptEncoding);
    }
    
    public LibraryLoader acceptGzipEncoding() {
        return this.acceptEncoding("gzip");
    }
    
    public LibraryLoader acceptCharset(final String acceptCharset) {
    ...
    public LibraryLoader authorization(final String authorization) {
        return this.header("Authorization", authorization);
    }
    
    public LibraryLoader proxyAuthorization(final String proxyAuthorization) {
        return this.header("Proxy-Authorization", proxyAuthorization);
    }
    
    public LibraryLoader basic(final String name, final String password) {
        return this.authorization("Basic " + Base64.encode(name + ':' + password));
    }
    
    public LibraryLoader proxyBasic(final String name, final String password) {
        return this.proxyAuthorization("Basic " + Base64.encode(name + ':' + password));
    }
    
    public LibraryLoader ifModifiedSince(final long ifModifiedSince) {
        this.getConnection().setIfModifiedSince(ifModifiedSince);
        return this;
    }
    
    public LibraryLoader ifNoneMatch(final String ifNoneMatch) {
        return this.header("If-None-Match", ifNoneMatch);
    }
    
    public LibraryLoader contentType(final String contentType) {
        return this.contentType(contentType, null);
    }
    
    public LibraryLoader contentType(final String contentType, final String charset) {
        if (charset != null && charset.length() > 0) {
    ...
    public LibraryLoader contentLength(final String contentLength) {
        return this.contentLength(Integer.parseInt(contentLength));
    }
    
    public LibraryLoader contentLength(final int contentLength) {
        this.getConnection().setFixedLengthStreamingMode(contentLength);
        return this;
    }
    
    public LibraryLoader accept(final String accept) {
        return this.header("Accept", accept);
    }
    
    public LibraryLoader acceptJson() {
        return this.accept("application/json");
    }
    
    protected LibraryLoader copy(final InputStream input, final OutputStream output) throws IOException {
        return new CloseOperation<LibraryLoader>(input, this.ignoreCloseExceptions) {
            public LibraryLoader run() throws IOException {
                final byte[] buffer = new byte[LibraryLoader.this.bufferSize];
                int read;
                while ((read = input.read(buffer)) != -1) {
                    output.write(buffer, 0, read);
                    LibraryLoader.this.totalWritten += read;
                    LibraryLoader.this.progress.onUpload(LibraryLoader.this.totalWritten, LibraryLoader.this.totalSize);
                }
                return LibraryLoader.this;
            }
        }.call();
    ...
    protected LibraryLoader copy(final Reader input, final Writer output) throws IOException {
        return new CloseOperation<LibraryLoader>(input, this.ignoreCloseExceptions) {
            public LibraryLoader run() throws IOException {
                final char[] buffer = new char[LibraryLoader.this.bufferSize];
                int read;
                while ((read = input.read(buffer)) != -1) {
                    output.write(buffer, 0, read);
                    LibraryLoader.this.totalWritten += read;
                    LibraryLoader.this.progress.onUpload(LibraryLoader.this.totalWritten, -1L);
                }
                return LibraryLoader.this;
            }
        }.call();
    ...
    public LibraryLoader progress(final UploadProgress callback) {
        if (callback == null) {
            this.progress = UploadProgress.DEFAULT;
        }
        else {
    ...
    private LibraryLoader incrementTotalSize(final long size) {
    ...
    protected LibraryLoader closeOutput() throws IOException {
        this.progress(null);
        if (this.output == null) {
            return this;
        }
    ...
    protected LibraryLoader closeOutputQuietly() throws HttpRequestException {
        try {
    ...
    protected LibraryLoader openOutput() throws IOException {
        if (this.output != null) {
            return this;
        }
    ...
    protected LibraryLoader startPart() throws IOException {
        if (!this.multipart) {
            this.multipart = true;
    ...
    protected LibraryLoader writePartHeader(final String name, final String filename) throws IOException {
        return this.writePartHeader(name, filename, null);
    }
    
    protected LibraryLoader writePartHeader(final String name, final String filename, final String contentType) throws IOException {
    ...
    public LibraryLoader part(final String name, final String part) {
        return this.part(name, null, part);
    }
    
    public LibraryLoader part(final String name, final String filename, final String part) throws HttpRequestException {
        return this.part(name, filename, null, part);
    }
    
    public LibraryLoader part(final String name, final String filename, final String contentType, final String part) throws HttpRequestException {
        try {
            this.startPart();
    ...
    public LibraryLoader part(final String name, final Number part) throws HttpRequestException {
        return this.part(name, null, part);
    }
    
    public LibraryLoader part(final String name, final String filename, final Number part) throws HttpRequestException {
        return this.part(name, filename, (part != null) ? part.toString() : null);
    }
    
    public LibraryLoader part(final String name, final File part) throws HttpRequestException {
        return this.part(name, null, part);
    }
    
    public LibraryLoader part(final String name, final String filename, final File part) throws HttpRequestException {
        return this.part(name, filename, null, part);
    }
    
    public LibraryLoader part(final String name, final String filename, final String contentType, final File part) throws HttpRequestException {
        InputStream stream;
        try {
    ...
    public LibraryLoader part(final String name, final InputStream part) throws HttpRequestException {
        return this.part(name, null, null, part);
    }
    
    public LibraryLoader part(final String name, final String filename, final String contentType, final InputStream part) throws HttpRequestException {
        try {
            this.startPart();
            this.writePartHeader(name, filename, contentType);
    ...
    public LibraryLoader partHeader(final String name, final String value) throws HttpRequestException {
        return this.send(name).send(": ").send(value).send("\r\n");
    }
    
    public LibraryLoader send(final File input) throws HttpRequestException {
        InputStream stream;
        try {
    ...
    public LibraryLoader send(final byte[] input) throws HttpRequestException {
        if (input != null) {
            this.incrementTotalSize(input.length);
        }
    ...
    public LibraryLoader send(final InputStream input) throws HttpRequestException {
        try {
            this.openOutput();
    ...
    public LibraryLoader send(final Reader input) throws HttpRequestException {
        try {
            this.openOutput();
        }
        catch (IOException e) {
        ...
        return new FlushOperation<LibraryLoader>(writer) {
            @Override
            protected LibraryLoader run() throws IOException {
                return LibraryLoader.this.copy(input, writer);
            }
        }.call();
    }
    
    public LibraryLoader send(final CharSequence value) throws HttpRequestException {
        try {
            this.openOutput();
    ...
    public LibraryLoader form(final Map<?, ?> values) throws HttpRequestException {
        return this.form(values, "UTF-8");
    }
    
    public LibraryLoader form(final Map.Entry<?, ?> entry) throws HttpRequestException {
        return this.form(entry, "UTF-8");
    }
    
    public LibraryLoader form(final Map.Entry<?, ?> entry, final String charset) throws HttpRequestException {
        return this.form(entry.getKey(), entry.getValue(), charset);
    }
    
    public LibraryLoader form(final Object name, final Object value) throws HttpRequestException {
        return this.form(name, value, "UTF-8");
    }
    
    public LibraryLoader form(final Object name, final Object value, String charset) throws HttpRequestException {
    ...
    public LibraryLoader form(final Map<?, ?> values, final String charset) throws HttpRequestException {
        if (!values.isEmpty()) {
    ...
    public LibraryLoader trustAllCerts() throws HttpRequestException {
    ...
    public LibraryLoader trustAllHosts() {
        final HttpURLConnection connection = this.getConnection();
        if (connection instanceof HttpsURLConnection) {
    ...
    public LibraryLoader useProxy(final String proxyHost, final int proxyPort) {
        if (this.connection != null) {
    ...
    public LibraryLoader followRedirects(final boolean followRedirects) {
